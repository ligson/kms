 ...
 * </pre>
 */
public class MyPKCS10CertificationRequest
    ...
    static {
        ...
        oids.put(AlgorithmId.SM3withSM2_oid, "SM3WITHSM2");
        ...
        keyAlgorithms.put(AlgorithmId.SM2_oid, "SM2");
     ...
     * byte stream.
     */
    public MyPKCS10CertificationRequest(
            byte[] bytes) {
    ...
    public MyPKCS10CertificationRequest(
        ...
        try {
            ...
            if (key.getAlgorithm().equals("SM2")) {
                ...
                seq = (ASN1Sequence) ASN1Object.fromByteArray(sm2PublicKey.getEncodedInternal());
            } else {
